...
const addContent = (content) => __awaiter(void 0, void 0, void 0, function* () {
    const response = yield fetch('http://localhost:5000/api/v1/content/', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            Authorization: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY3OTI0YWE1NDc3MmQ5Y2M1YjAyZDg0YyIsImlhdCI6MTczNzY0MDYyNn0.K3ZSTAqQuzdydz4ez1jRE9IL-Cnkc7R-6IB7JbMCcM0',
        },
    ...
    if (response.ok) {
        ...
        console.error(`Failed to add: ${content.title}`, yield response.json());
    }
});
const addBulkData = () => __awaiter(void 0, void 0, void 0, function* () {
    for (const content of bulkData) {
        yield addContent(content);
    }
});
addBulkData();
